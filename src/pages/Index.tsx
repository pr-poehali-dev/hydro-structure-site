        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-foreground">ГидроПроект</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h1 className="text-5xl md:text-6xl font-bold text-foreground leading-tight">
                Проектирование гидросооружений
              </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center gap-2 mb-4 md:mb-0">
              ...
              <span className="text-xl font-bold">ГидроПроект</span>
            </div>
            <p className="text-white/80">© 2024 ГидроПроект. Все права защищены.</p>
          </div>
        </div>
      </footer>
    </div>
